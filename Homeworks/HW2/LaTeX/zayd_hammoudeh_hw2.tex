...
\caption{not Evaluation Order Rules}
{\bf not Evaluation Rules:} \\
\[
\begin{array}{r@{\qquad\qquad}l}
...
\caption{and Evaluation Order Rules}
{\bf and Evaluation Rules:} \\
\[
\begin{array}{r@{\qquad\qquad}l}
...
\caption{or Evaluation Order Rule}
{\bf or Evaluation Rules:} \\
\[
\begin{array}{r@{\qquad\qquad}l}
